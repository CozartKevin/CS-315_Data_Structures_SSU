...
public:
    ...
    std::string romanNumber() const
    { return _romanNumber; }

    void romanNumber(std::string str)
    { _romanNumber = str; }
    ...
    bool isMultiplicationOperator() const
    { return _symbol == '*'; }

    bool isAdditionOperator() const
    { return _symbol == '+'; }

    bool isSubtractionOperator() const
    { return _symbol == '-'; }

    bool isModuloOperator() const
    { return _symbol == '%'; }

    bool isDivisionOperator() const
    { return _symbol == '/'; }

    bool isAVariable() const
    { return _symbol >= 'a' && _symbol <= 'z'; }

    char getVariable() const
    { return _symbol; }

    bool isRomanNumber() const
    { return _romanNumber.length() > 0; }
