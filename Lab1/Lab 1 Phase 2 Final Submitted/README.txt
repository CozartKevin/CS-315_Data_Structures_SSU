...
09/15/2019:
Fixed all small bugs.  Output is as desired. 
Removed all extra code for error checking. 
Added comments
Adjusted spacing on map output to closer reflect blue cs output test.
